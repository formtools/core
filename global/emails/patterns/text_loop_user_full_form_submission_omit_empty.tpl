...
{literal}{if $ANSWER_{/literal}{$field.field_name}{literal}}{/literal}{$field.field_title}: {literal}{$ANSWER_{/literal}{$field.field_name}{literal}}{/literal}{literal}{/if}{/literal}
{else}

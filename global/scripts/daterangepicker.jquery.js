...
jQuery.fn.daterangepicker = function(settings){
	...
	var rpPresets = (function(){
		...
		// added for Form Tools
		var presetRangeIndex = 0;
		jQuery.each(options.presetRanges,function(){
			jQuery('<li class="ui-daterangepicker-'+ this.text.replace(/ /g, '') +' presetRange' + presetRangeIndex + ' ui-corner-all"><a href="#">'+ this.text +'</a></li>')

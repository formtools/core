...
$LANG["confirm_delete_submissions_on_other_pages"] = "<b>Warning!</b> You have selected <b>{\$num_selected_on_page}</b> submissions on this page and <b>{\$num_selected_on_other_pages}</b> on other pages. Please choose one of the following options:<div class=\"margin_top_large\"><input type=\"button\" value=\"Delete All Selected Submissions\" {\$delete_all_submissions_onclick} /> <input type=\"button\" value=\"Only Delete Submissions Selected on this Page\" {\$delete_submissions_on_page_onclick} /></div>";

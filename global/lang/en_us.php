...
$LANG["text_user_account_placeholders_explanation"] = "These placeholders have limited availability. They may be used in email templates sent only to the admin and client accounts. If they are used in emails sent to to other people (e.g. users: the people who submitted the form), they will appear blank.";

{ft_include file='header.tpl'}
  ...
  {if     $page == "main"}
    {ft_include file='admin/forms/edit/tab_main.tpl'}
  {elseif $page == "public_form_omit_list"}
    {ft_include file='admin/forms/edit/tab_public_form_omit_list.tpl'}
  {elseif $page == "fields"}
    {ft_include file='admin/forms/edit/tab_fields.tpl'}
  {elseif $page == "field_options"}
    {ft_include file='admin/forms/edit/tab_field_options.tpl'}
  {elseif $page == "files"}
    {ft_include file='admin/forms/edit/tab_files.tpl'}
  {elseif $page == "emails"}
    {ft_include file='admin/forms/edit/tab_emails.tpl'}
  {elseif $page == "email_settings"}
    {ft_include file='admin/forms/edit/tab_email_settings.tpl'}
  {elseif $page == "edit_email"}
    {ft_include file='admin/forms/edit/tab_edit_email.tpl'}
  {elseif $page == "views"}
    {ft_include file='admin/forms/edit/tab_views.tpl'}
  {elseif $page == "edit_view"}
    {ft_include file='admin/forms/edit/tab_edit_view.tpl'}
  {elseif $page == "public_view_omit_list"}
    {ft_include file='admin/forms/edit/tab_public_view_omit_list.tpl'}
  {elseif $page == "add_view"}
    {ft_include file='admin/forms/edit/tab_add_view.tpl'}
  {elseif $page == "database"}
    {ft_include file='admin/forms/edit/tab_database.tpl'}
  {else}

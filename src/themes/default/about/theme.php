...
$theme_version = "1.0.0";
$theme_uses_swatches = "yes";

$theme_swatches = array(
  "red"         => "{\$LANG.word_red}",
  "orange"      => "{\$LANG.word_orange}",
  "yellow"      => "{\$LANG.word_yellow}",
  "green"       => "{\$LANG.word_green}",
  "aquamarine"  => "{\$LANG.word_aquamarine}",
  "blue"        => "{\$LANG.word_blue}",
  "dark_blue"   => "{\$LANG.phrase_dark_blue}",
  "purple"      => "{\$LANG.word_purple}",
  "grey"        => "{\$LANG.word_grey}",
  "light_brown" => "{\$LANG.phrase_light_brown}"
);

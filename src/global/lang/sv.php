...
$LANG["text_default_theme_cache_folder_not_writable"] = "Innan du fortsätter behöver du uppdatera din katalog <strong>/cache</strong> till att tillåta fulla läs- och skrivrättigheter. När det väl är gjort kommer detta meddelande att försvinna och du kan installera scriptet.";

...
$core_field_types_module_available = Installation::checkModuleAvailable("core_field_types");

$page_vars = array();
$page_vars["step"] = 2;
$page_vars["valid_php_version"] = $valid_php_version;
$page_vars["pdo_available"] = extension_loaded("PDO");
$page_vars["pdo_mysql_available"] = extension_loaded("pdo_mysql");

...
// time
$g_sql[] = "INSERT INTO %PREFIX%field_type_setting_options VALUES (24, '8:00 AM', 'h:mm TT|ampm`true', 1, 'yes')";
$g_sql[] = "INSERT INTO %PREFIX%field_type_setting_options VALUES (24, '16:00', 'hh:mm|ampm`false', 2, 'yes')";
$g_sql[] = "INSERT INTO %PREFIX%field_type_setting_options VALUES (24, '16:00:00', 'hh:mm:ss|showSecond`true|ampm`false', 3, 'yes')";

// code / markup
$g_sql[] = "INSERT INTO %PREFIX%field_type_setting_options VALUES (28, 'CSS', 'CSS', 1, 'yes')";
$g_sql[] = "INSERT INTO %PREFIX%field_type_setting_options VALUES (28, 'HTML', 'HTML', 2, 'yes')";
$g_sql[] = "INSERT INTO %PREFIX%field_type_setting_options VALUES (28, 'JavaScript', 'JavaScript', 3, 'yes')";
$g_sql[] = "INSERT INTO %PREFIX%field_type_setting_options VALUES (28, 'XML', 'XML', 4, 'yes')";
$g_sql[] = "INSERT INTO %PREFIX%field_type_setting_options VALUES (29, 'Tiny (50px)', '50', 1, 'yes')";
$g_sql[] = "INSERT INTO %PREFIX%field_type_setting_options VALUES (29, 'Small (100px)', '100', 2, 'yes')";
$g_sql[] = "INSERT INTO %PREFIX%field_type_setting_options VALUES (29, 'Medium (200px)', '200', 3, 'yes')";
$g_sql[] = "INSERT INTO %PREFIX%field_type_setting_options VALUES (29, 'Large (400px)', '400', 4, 'yes')";
...
// textbox
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (1, 1, 'Size', 'size', select', 'SIZE', 'na', 'size_medium', 1)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (2, 1, 'Max Length', 'maxlength', 'textbox', 'MAXLENGTH', 'na', '', 2)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (3, 1, 'Highlight', 'highlight', 'select', 'HIGHLIGHT', 'na', '', 4)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (4, 1, 'Field Comments', 'comments', 'textarea', 'COMMENTS', 'na', '', 3)";

// textarea
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (5, 2, 'Height', 'height', 'select', 'SIZE_CLASS', 'na', 'size_medium', 1)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (6, 2, 'Highlight Colour', 'highlight_colour', select', 'HIGHLIGHT', 'na', '', 3)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (7, 2, 'Input length', 'input_length', 'radios', 'INPUTSIZE', 'horizontal', '', 4)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (8, 2, '- Max length (words/chars)', 'maxlength', 'textbox', 'MAXLENGTH', 'na', '', 5)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (9, 2, 'Field Comments', 'comments', 'textarea', 'COMMENTS', 'na', '', 2)";

// password
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (10, 3, 'Field Comments', 'comments', 'textarea', 'COMMENTS', 'na', '', 1)";

// dropdown
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (11, 4, 'Option List / Contents', 'contents', 'option_list_or_form_field', 'OPTIONLIST', 'na', '', 1)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (12, 4, 'Field Comments', 'comments', 'textarea', 'COMMENTS', 'na', '', 2)";

// multi-select dropdown
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (13, 5, 'Option List / Contents', 'contents', 'option_list_or_form_field', 'OPTIONLIST', 'na', '', 1)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (14, 5, 'Num Rows', 'num_rows', 'textbox', 'SIZE', 'na', '5', 2)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (15, 5, 'Field Comments', 'comments', 'textarea', 'COMMENTS', 'na', '', 3)";

// radios
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (16, 6, 'Option List / Contents', 'contents', 'option_list_or_form_field', 'OPTIONLIST', 'na', '', 1)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (17, 6, 'Formatting', 'select', 'formatting', 'FORMATTING', 'na', 'horizontal', 2)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (18, 6, 'Field Comments', 'comments',' 'textarea', 'COMMENTS', 'na', '', 3)";

// checkboxes
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (19, 7, 'Option List / Contents', 'contents', 'option_list_or_form_field', 'OPTIONLIST', 'na', '', 1)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (20, 7, 'Formatting', 'formatting', 'select', 'FORMATTING', 'na', 'horizontal', 2)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (21, 7, 'Field Comments', 'comments', 'textarea', 'COMMENTS', 'na', '', 3)";

// date
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (22, 8, 'Custom Display Format', 'display_format', 'select', 'DISPLAYFORMAT', 'na', 'yy-mm-dd', 1)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (23, 8, 'Field Comments', 'comments', 'textarea', 'COMMENTS', 'na', '', 2)";

// time
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (24, 9, 'Custom Display Format', 'display_format', 'select', 'DISPLAYFORMAT', 'na', 'h:mm TT|ampm`true', 1)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (25, 9, 'Field Comments', 'comments', 'textarea', 'COMMENTS', 'na', '', 2)";

// phone number
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (26, 10, 'Phone Number Format', 'phone_number_format', 'textbox', 'FORMAT', 'na', '(xxx) xxx-xxxx', 1)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (27, 10, 'Field Comments', 'comments', 'textarea', 'COMMENTS', 'na', '', 2)";

// code / markup
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (28, 11, 'Code / Markup Type', 'code_markup', 'select', 'TYPE', 'na', 'HTML', 1)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (29, 11, 'Height', 'height', 'select', 'SIZE_PX', 'na', 'size_medium', 2)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (30, 11, 'Field Comments', 'comments', 'textarea', 'COMMENTS', 'na', '', 3)";

...
// textbox
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (1, 1, 'Size', 'select', 'SIZE', 'na', 'size_medium', 1)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (2, 1, 'Max Length', 'textbox', 'MAXLENGTH', 'na', '', 2)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (3, 1, 'Highlight', 'select', 'HIGHLIGHT', 'na', '', 4)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (4, 1, 'Field Comments', 'textarea', 'COMMENTS', 'na', '', 3)";

// textarea
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (5, 2, 'Height', 'select', 'SIZE_CLASS', 'na', 'size_medium', 1)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (6, 2, 'Highlight Colour', 'select', 'HIGHLIGHT', 'na', '', 3)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (7, 2, 'Input length', 'radios', 'INPUTSIZE', 'horizontal', '', 4)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (8, 2, '- Max length (words/chars)', 'textbox', 'MAXLENGTH', 'na', '', 5)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (9, 2, 'Field Comments', 'textarea', 'COMMENTS', 'na', '', 2)";

// password
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (10, 3, 'Field Comments', 'textarea', 'COMMENTS', 'na', '', 1)";

// dropdown
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (11, 4, 'Option List / Contents', 'option_list_or_form_field', 'OPTIONLIST', 'na', '', 1)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (12, 4, 'Field Comments', 'textarea', 'COMMENTS', 'na', '', 2)";

// multi-select dropdown
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (13, 5, 'Option List / Contents', 'option_list_or_form_field', 'OPTIONLIST', 'na', '', 1)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (14, 5, 'Num Rows', 'textbox', 'SIZE', 'na', '5', 2)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (15, 5, 'Field Comments', 'textarea', 'COMMENTS', 'na', '', 3)";

// radios
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (16, 6, 'Option List / Contents', 'option_list_or_form_field', 'OPTIONLIST', 'na', '', 1)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (17, 6, 'Formatting', 'select', 'FORMATTING', 'na', 'horizontal', 2)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (18, 6, 'Field Comments', 'textarea', 'COMMENTS', 'na', '', 3)";

// checkboxes
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (19, 7, 'Option List / Contents', 'option_list_or_form_field', 'OPTIONLIST', 'na', '', 1)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (20, 7, 'Formatting', 'select', 'FORMATTING', 'na', 'horizontal', 2)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (21, 7, 'Field Comments', 'textarea', 'COMMENTS', 'na', '', 3)";

// date
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (22, 8, 'Custom Display Format', 'select', 'DISPLAYFORMAT', 'na', 'yy-mm-dd', 1)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (23, 8, 'Field Comments', 'textarea', 'COMMENTS', 'na', '', 2)";

// time
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (24, 9, 'Custom Display Format', 'select', 'DISPLAYFORMAT', 'na', 'h:mm TT|ampm`true', 1)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (25, 9, 'Field Comments', 'textarea', 'COMMENTS', 'na', '', 2)";

// phone number
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (26, 10, 'Phone Number Format', 'textbox', 'FORMAT', 'na', '(xxx) xxx-xxxx', 1)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (27, 10, 'Field Comments', 'textarea', 'COMMENTS', 'na', '', 2)";

// code / markup
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (28, 11, 'Code / Markup Type', 'select', 'TYPE', 'na', 'HTML', 1)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (29, 11, 'Height', 'select', 'SIZE_PX', 'na', 'size_medium', 2)";
$g_sql[] = "INSERT INTO %PREFIX%field_type_settings VALUES (30, 11, 'Field Comments', 'textarea', 'COMMENTS', 'na', '', 3)";

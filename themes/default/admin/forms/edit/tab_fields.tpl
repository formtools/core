...
<form action="{$same_page}" name="display_form" id="display_form" method="post">
    ...
    <div class="sortable groupable scrollable edit_fields" id="{$sortable_id}">
        ...
        <input type="hidden" class="tabindex_col_selectors"
               value=".rows .col2 input|.rows .col3 .sub_col1 input|.rows .col3 .sub_col2 select|.rows .col3 .sub_col3 input|.rows .col3 .sub_col4 select|.rows .col3 .sub_col5 select|.rows .col3 .sub_col6 input"/>
                ...
                <ul>
                    ...
                    <li class="subcol_header">
                        <ul class="scroll-content">
                            ...
                            <li class="sub_col6">{$LANG.phrase_db_column}<span class="pad_right">&nbsp;</span><input
                                        type="button" value="{$LANG.phrase_smart_fill}"
                ...
                <ul>
                    ...
                    <li class="col3 scrollable">
                        <ul class="scroll-content">
                            ...
                            <li class="sub_col2">
                                <input type="hidden" name="old_field_{$field_id}_type_id"
                                       id="old_field_{$field_id}_type_id" class="system_field_type_id"
                        ...
                        {/if}
                            ...
                            <li class="sub_col3 check_area">
                                <input type="checkbox" name="field_{$field_id}_include_on_redirect"
                                       id="field_{$field_id}_include_on_redirect"
                            ...
                            <li class="sub_col4">
                                {if $field.is_system_field == "yes"}
                                    <span class="pad_left_small medium_grey">{$LANG.word_na}</span>
                                {else}
                                    <input type="hidden" name="old_field_{$field_id}_size"
                                           id="old_field_{$field_id}_size" value="{$field.field_size}"/>
                            ...
                            <li class="sub_col5">
                                {if $field.is_system_field == "yes"}
                                    <span class="pad_left_small medium_grey">{$LANG.word_na}</span>
                                {else}
                                    <select name="field_{$field_id}_data_type" id="field_{$field_id}_data_type"
                                            class="data_types">
                                        <option {if $field.data_type == "string"}selected{/if}
                                                value="string">{$LANG.word_string}</option>
                                        <option {if $field.data_type == "number"}selected{/if}
                                                value="number">{$LANG.word_number}</option>
                                    </select>
                                {/if}
                            </li>
                            <li class="sub_col6">
        ...
        <div class="scroll-pane ui-corner-all" style="border: 0px; margin-left: 239px; margin-top: -2px">
            <div class="scroll-bar-wrap ui-widget-content ui-corner-bottom"
                 style="border: 1px solid #aaaaaa; border-top: 0px; margin: 0px; height:20px">
            ...
            <div class="inner_tab_content2" style="display:none">
                <form id="edit_field_form_tab2">
                    <div id="edit_field__field_settings_loading"
                         class="medium_grey">{$LANG.phrase_loading_ellipsis}</div>

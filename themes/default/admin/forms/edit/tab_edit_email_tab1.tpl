<table cellpadding="2" cellspacing="1" width="100%" class="margin_bottom">
    <tr>
        ...
        <td><input type="text" name="email_template_name" value="{$template_info.email_template_name|escape}"
    ...
    <tr>
        ...
        <td>
            <input type="radio" name="email_status" id="status_enabled" value="enabled"
                   {if $template_info.email_status == "enabled"}checked="checked"{/if} />
            ...
            <input type="radio" name="email_status" id="status_disabled" value="disabled"
                   {if $template_info.email_status == "disabled"}checked="checked"{/if} />
...
<div class="grey_box">
    <div>
        <a href="#"
           onclick="return emails_ns.toggle_advanced_settings()">{$LANG.phrase_advanced_settings_rightarrow}</a>
    </div>
            ...
            <tr>
                ...
                <td>
                    <input type="radio" name="view_mapping_type" id="vmt1" value="all"
                           {if $template_info.view_mapping_type == "all"}checked="checked"{/if} />
                    ...
                    <input type="radio" name="view_mapping_type" id="vmt2" value="specific"
                           {if $template_info.view_mapping_type == "specific"}checked="checked"{/if}
                    ...
                    {else}
                        ...
                        <div id="when_sent_views"
                             {if $template_info.view_mapping_type != "specific"}style="display:none"{/if}>
                            <table width="100%">
                                <tr>
                                    <td>

          ...
          {else}
            ...
            <tr>
              ...
              <td rowspan="3" width="120" class="subpanel" align="center">
                <input type="button" name="send_test_email" value="{$LANG.phrase_send_test_email}"
                  onclick="return emails_ns.send_test_email(this.form, 'send')" />
                <input type="button" name="display_email" value="Display Email"
                  onclick="return emails_ns.send_test_email(this.form, 'display')" />
              </td>
            </tr>
            <tr>
            ...
            <div id="display_text" style="display:none; padding: 8px; background-color: #f9f9f9; border: 1px solid #666666;">

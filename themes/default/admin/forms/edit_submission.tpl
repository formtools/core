            ...
            <td align="right">
                <div style="float:right; padding-left: 4px;">
                    <a href="edit/?form_id={$form_id}"><img src="{$images_url}/admin_view.png" border="0"
                                                            ...
                                                            title="{$LANG.phrase_edit_form}" width="48"
                                                            height="23"/></a>
                </div>
          ...
          {* show the list of whatever email templates can be send from this page *}
            ...
            {if $view_info.may_delete_submissions == "yes"}
                <input type="button" name="delete" value="{$LANG.word_delete}" class="red"
                       onclick="return ms.delete_submission({$submission_id}, 'submissions.php')"/>
            {/if}
            {if $view_info.may_add_submissions == "yes"}
                ...
                <input type="button" value="{eval var=$form_info.add_submission_button_label}"
                       onclick="window.location='submissions.php?form_id={$form_id}&add_submission'"/>
            {/if}

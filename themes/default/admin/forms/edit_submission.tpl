          ...
          {else}
            ...
            {if $submission_field.is_editable == "yes"}
              ...
              {elseif $submission_field.field_size == "medium"}
                <input type="text" name="{$submission_field.col_name}" value="{$submission_field.content|escape}" style="width: 99%;" />
              {elseif $submission_field.field_size == "large" || $submission_field.field_size == "very_large"}
                <textarea name="{$submission_field.col_name}" style="width: 99%; height: 80px">{$submission_field.content}</textarea>
              {/if}
            {else}
              {$submission_field.content}
            {/if}
